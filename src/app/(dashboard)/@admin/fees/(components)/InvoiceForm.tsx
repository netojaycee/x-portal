...
const InvoiceFormSchema = z.object({
  ...
  // For mass
  classIds: z.array(z.string()).min(1, "At least one class is required"), // For single
...
export default function InvoiceForm({
  ...
  const [selectedClassId, setSelectedClassId] = useState<string>(
    initialData?.invoiceType === "single" &&
      initialData?.classIds?.length &&
      initialData.classIds.length > 0
      ? initialData.classIds[0]
      : ""
  );
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select
                        value={field.value?.[0] || ""} // Get first item since it's single
                        onValueChange={(val) => {
